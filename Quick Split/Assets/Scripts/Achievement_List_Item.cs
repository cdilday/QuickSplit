...
public class Achievement_List_Item : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        if (isSplitter)
        {
            unlocked = achievementHandler.is_Splitter_Unlocked(SplitterHelper.Get_SplitterType_Enum(unlockable));
        }
        else
        {
            unlocked = achievementHandler.is_Pieceset_Unlocked(PieceSetHelper.Get_Pieceset_Enum(unlockable));
        }
